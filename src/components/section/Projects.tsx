...
// ── Project data ──────────────────────────────────────────────────────────────
const getResearchProjects = (t: TranslationKeys) => [
  {
    title: t.projects.projects.oilSpill.title,
    description: t.projects.projects.oilSpill.description,
  ...
  {
    title: t.projects.projects.flight.title,
    description: t.projects.projects.flight.description,
  ...
  {
    title: t.projects.projects.road.title,
    description: t.projects.projects.road.description,
...
const getPersonalProjects = (t: TranslationKeys) => [
  {
    title: t.projects.projects.reef.title,
    description: t.projects.projects.reef.description,
  ...
  {
    title: t.projects.projects.ghibli.title,
    description: t.projects.projects.ghibli.description,
...
// ── Project card ──────────────────────────────────────────────────────────────
const ProjectCard = ({ project, isDarkMode, themeColors, githubLabel, demoLabel }: {
  project: ReturnType<typeof getResearchProjects>[0];
  isDarkMode: boolean;
  themeColors: ReturnType<typeof useThemeColors>;
  githubLabel: string;
  demoLabel: string;
...
const Projects = () => {
  ...
  const researchProjects = getResearchProjects(t);
  ...
  return (
    <section id="projects" className="py-20 relative transition-colors duration-300"
      ...
      <div style={{ position: 'absolute', left: '85%', top: '5%', zIndex: 16, display: 'flex', alignItems: 'center', gap: 8, pointerEvents: 'none' }}>
        ...
        <span style={{ fontFamily: "'DK Crayonista', cursive", fontSize: 26, color: isDarkMode ? '#FDD5DF' : '#ec4899', fontWeight: 'bold', userSelect: 'none' }}>{t.projects.dragMe}</span>
      </div>
      ...
      <TooltipProvider delayDuration={200}>
        <div className="container mx-auto px-6 relative z-10">
          ...
          {/* Research section */}
          <SectionLabel>{t.projects.sectionResearch}</SectionLabel>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mb-16">
            {researchProjects.map((p, i) => (
              <ProjectCard key={i} project={p} isDarkMode={isDarkMode} themeColors={themeColors} githubLabel={t.projects.github} demoLabel={t.projects.liveDemo} />
            ))}
          </div>

          {/* Personal section */}
          <SectionLabel>{t.projects.sectionPersonal}</SectionLabel>
